...
export class HmiServer {
    ...
    _pushNewElementToServices() {
        ...
        Promise.all(ingests.map((ingest) => {
    ...
    _getAllElementStates() {
        ...
        return Promise.all(Object.values(elements).map((element) => {
...
export class HmiElement extends EventEmitter {
    constructor(options = {}) {
        const { attributes = {}, getter = null, name = null, server = null, settable = false } = options;
