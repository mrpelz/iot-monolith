...
export class HttpServer extends EventEmitter {
    ...
    constructor(options = {}) {
        super();
        this._httpServer = {};
        const { host = '0.0.0.0', port = null, handler = null, headers = {} } = options;
        if (!host || !port) {
    ...
    _handleRequest(request, response) {
        ...
        const { log, globalHandler, options: { host, port, headers: globalHeaders, routes } } = this._httpServer;
        ...
        Object.assign(request, {
            urlQuery: arraysToObject([...request.url.searchParams.keys()], [...request.url.searchParams.values()])
        });
        ...
        const { handler = null, resolveCode = 200, rejectCode = 500, headers: localHeaders = {}, openEnd = false } = match;
