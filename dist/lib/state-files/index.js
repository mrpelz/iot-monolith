import { existsSync as exists, openSync as open, readFile as read, readFileSync as readSync, ftruncate as truncate, ftruncateSync as truncateSync, watch, writeFile as write, writeFileSync as writeSync } from 'fs';
...
export class StateFile extends EventEmitter {
    ...
    set(data) {
        ...
        return new Promise((resolve, reject) => {
            ...
            truncate(this._descriptor, (truncateError) => {
                ...
                write(this._descriptor, Buffer.from(json), (writeError) => {
                    this._doWatch = true;
                    if (writeError) {
    ...
    get() {
        return new Promise((resolve, reject) => {
            read(this._descriptor, (readError, data) => {
                if (readError) {
