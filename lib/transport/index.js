...
class TransportDevice {
  ...
  instanceToTransport(payload) {
    ...
    transport.write(deviceIdentifier, payload);
  }

  transportToInstance(identifier, payload) {
    const {
      transport: {
        state: {
          identifier: transportIdentifier
...
class Transport extends Base {
  ...
  _writeToDeviceInstances(identifier, payload) {
    ...
    devices.forEach((device) => {
      device.transportToInstance(identifier, payload);
    });
  }
...
class AggregatedTransport extends Base {
