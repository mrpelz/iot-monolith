...
export const devices = {
  ...
  ceilingLightRGB: shelly1(
    'lighting' as const,
    'mrpelzbedroom-ceilinglightrgb.lan.wurstsalat.cloud',
    context,
  ),
  doorSensor: ev1527WindowSensor(724_720, ev1527Transport, context),
  heatLamp: sonoffBasic(
    'heating' as const,
    'mrpelzbedroom-heatlamp.lan.wurstsalat.cloud',
    context,
  ),
  ionGenerator: sonoffBasic(
    'heating' as const,
    'mrpelzbedroom-iongenerator.lan.wurstsalat.cloud',
    context,
  ),
  ...
  standingLamp: obiPlug(
    'lighting' as const,
    'mrpelzbedroom-standinglamp.lan.wurstsalat.cloud',
    context,
  ),
...
export const properties = {
  ...
  ceilingLightRGB: devices.ceilingLightRGB.relay,
...
const scenes = {
  allOff: scene(
    ...
    [
      ...
      new SceneMember(properties.ceilingLightRGB.main.setState, false),
    ],
    'light',
  ),
  allRed: scene(
